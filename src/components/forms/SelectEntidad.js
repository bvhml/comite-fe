    ...
    return (
        <div style={{ width: fieldItem.columnSize, display: 'inline-block', padding: '1rem' }} key={field.name}>
            <FormControl fullWidth={true} margin="dense">
                ...
                <Select className="formulario-entidad__input" id={field.name} name={field.name} required={fieldItem.required} value={field.value} onChange={field.onChange} children={
